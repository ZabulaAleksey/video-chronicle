...
| Единый date/time formatter, typography, font fallback, preview, reanalysis после смены формата и multi-item export | unit/GUI/integration | `tests/test_overlay.py`, `tests/test_gui_application.py`, `tests/test_nondestructive_editing.py` | `OVERLAY-AC-001–003`, `OVERLAY-007–009`, `AC-004/010` |
